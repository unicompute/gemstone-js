...
for (const name of ["quickstart", "maglev-branch-usage", "gstore", "persistent-root", "simple-dictionary", "object-mapping", "object-mapping-manifest", "transparent-object-mapping", "smalltalk-bridge", "query", "bulk-perform", "migrations", "object-log", "web-express", "web-fetch", "web-route-handler"]) {
