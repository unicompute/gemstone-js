...
const required = [
  ...
  "examples/deconstructed-transactions.ts",
  "examples/explorer.ts",
  "examples/external-structure-dictionary.ts",
  "examples/gstore.ts",
...
for (const name of ["quickstart", "maglev-branch-usage", "gstore", "persistent-root", "simple-dictionary", "external-structure-dictionary", "deconstructed-transactions", "object-mapping", "object-mapping-manifest", "transparent-object-mapping", "smalltalk-bridge", "query", "bulk-perform", "migrations", "object-log", "web-express", "web-fetch", "library-books", "web-route-handler"]) {
