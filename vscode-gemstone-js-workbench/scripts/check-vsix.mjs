...
function assertPackagedManifest(manifest, vsixManifest) {
  ...
  const expectedActivationEvents = [
    ...
    "onCommand:gemstoneJs.copyConnectionSummary",
    "onCommand:gemstoneJs.copyDoctorReport",
    "onCommand:gemstoneJs.openWorkspace",
    "onCommand:gemstoneJs.openGlobals",
    "onCommand:gemstoneJs.openRoots",
    "onCommand:gemstoneJs.openSymbolList",
    "onCommand:gemstoneJs.openCodegen",
    ...
    "onCommand:gemstoneJs.setOpenMode",
    "onCommand:gemstoneJs.setNativeSessionWorker",
  ...
  assertArrayIncludesAll(
    ...
    ["gemstoneJs.inspectOop", "gemstoneJs.copyOop", "gemstoneJs.copyObjectName", "gemstoneJs.openClassBrowser", "gemstoneJs.copyClassName"],
